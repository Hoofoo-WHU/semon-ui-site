...
function getNext(title) {
  var next = keys[keys.indexOf(title) + 1];
  return next ? Posts[next] : null;
}
function getPrev(title) {
  var prev = keys[keys.indexOf(title) - 1];
  return prev ? Posts[prev] : null;
}
var data = {
...
//# sourceMappingURL=_app.js.62df7eb5bf33800e3a60.hot-update.js.map