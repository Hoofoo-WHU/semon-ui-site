...
var data = {
  ...
  opens: ['components'],
  data: [Posts.introduce, Posts['getting-started'], new PostSubMenuData('Components', 'components', [new PostGroupData('通用', [Posts.button, Posts.icon]), new PostGroupData('布局', [Posts.grid, Posts.layout]), new PostGroupData('导航', [Posts.menu]), new PostGroupData('表单', [])])]
};
...
//# sourceMappingURL=_app.js.9bb2854b9dbb1fde370a.hot-update.js.map