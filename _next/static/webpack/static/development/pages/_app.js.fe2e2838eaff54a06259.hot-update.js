...
var data = {
  ...
  opens: ['components'],
  data: [Posts.introduce, Posts['getting-started'], new PostSubMenuData('Components', 'components', [new PostGroupData('通用', [Posts.button, Posts.icon]), new PostGroupData('布局', [Posts.grid, Posts.layout]), new PostGroupData('导航', [Posts.menu])])]
};
...
//# sourceMappingURL=_app.js.fe2e2838eaff54a06259.hot-update.js.map